<script>
	...
	function getSVGPartColor(partId) {
		...
		if (state.status === "dent")
			return "fill-orange-100/60  stroke-orange-500 ";
		if (state.status === "crack")
			return "fill-purple-100/60  stroke-purple-500 ";
		if (state.status === "broken")
			return "fill-transparent  stroke-red-500 ";
		if (state.status === "damaged")
			return "fill-indigo-100/60  stroke-indigo-500 ";
...
>
	...
	>
		...
		<svg viewBox="20 0 160 400" class="w-full h-full select-none">
			...
			<rect
				...
				height="40"
				rx="4"
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'left_front_wheel', )} {activePart === 'left_front_wheel' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<rect
				...
				height="40"
				rx="4"
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'right_front_wheel', )} {activePart === 'right_front_wheel' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<rect
				...
				height="40"
				rx="4"
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'left_rear_wheel', )} {activePart === 'left_rear_wheel' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<rect
				...
				height="40"
				rx="4"
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'right_rear_wheel', )} {activePart === 'right_rear_wheel' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<path
				...
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'front_bumper', )} {activePart === 'front_bumper' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<path
				...
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'hood', )} {activePart === 'hood' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<path
				...
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'windshield', )} {activePart === 'windshield' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<rect
				...
				height="85"
				rx="8"
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'roof', )} {activePart === 'roof' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<rect
				...
				height="38"
				rx="2"
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'left_front_window', )} {activePart === 'left_front_window' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<rect
				...
				height="38"
				rx="2"
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'left_rear_window', )} {activePart === 'left_rear_window' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<rect
				...
				height="38"
				rx="2"
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'right_front_window', )} {activePart === 'right_front_window' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<rect
				...
				height="38"
				rx="2"
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'right_rear_window', )} {activePart === 'right_rear_window' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<path
				...
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'rear_glass', )} {activePart === 'rear_glass' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<path
				...
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'trunk', )} {activePart === 'trunk' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<path
				...
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'rear_bumper', )} {activePart === 'rear_bumper' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<path
				...
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'left_fender', )} {activePart === 'left_fender' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<path
				...
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'left_front_door', )} {activePart === 'left_front_door' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<path
				...
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'left_rear_door', )} {activePart === 'left_rear_door' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<path
				...
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'left_rear_quarter', )} {activePart === 'left_rear_quarter' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<path
				...
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'right_fender', )} {activePart === 'right_fender' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<path
				...
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'right_front_door', )} {activePart === 'right_front_door' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<path
				...
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'right_rear_door', )} {activePart === 'right_rear_door' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
			...
			<path
				...
				class="transition-colors duration-300 cursor-pointer focus:outline-none focus:stroke-blue-500 {getSVGPartColor( 'right_rear_quarter', )} {activePart === 'right_rear_quarter' ? 'stroke-blue-500 stroke-[2px]' : 'stroke-1'}"
				role="button"
				tabindex="0"
	...
	<div class="flex-1 w-full">
		<h3
			class="text-lg font-bold text-slate-800 mb-4 flex items-center justify-between"
		>
			<span>Interior do carro</span>
		</h3>

		<div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
			{#each parts.filter((part) => part.isSpecial) as part}
				<button
					type="button"
					onclick={() => (activePart = part.id)}
					class="flex flex-col text-left p-3 rounded-xl border transition-all duration-200 cursor-pointer outline-none relative group {getStatusColor( part.id, )} {activePart === part.id ? 'ring-2 ring-blue-500 border-blue-500 scale-[1.02] shadow-lg shadow-blue-500/10' : ''}"
				>
